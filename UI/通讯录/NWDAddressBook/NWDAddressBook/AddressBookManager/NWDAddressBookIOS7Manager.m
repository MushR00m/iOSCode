...
@interface NWDAddressBookIOS7Manager () <ABPeoplePickerNavigationControllerDelegate>

@property(nonatomic,copy) NWDAddressBookChooseBlock chooseBlock;

@end

@implementation NWDAddressBookIOS7Manager

+ (NWDAddressBookIOS7Manager *)manager
{
    static NWDAddressBookIOS7Manager *sharedInstance = nil;
    if (!sharedInstance) {

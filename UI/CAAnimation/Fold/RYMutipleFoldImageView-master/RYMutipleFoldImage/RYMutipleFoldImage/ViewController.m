...
//    CATransform3D moveTransform1 = CATransform3DMakeAffineTransform(CGAffineTransformMakeTranslation(0, 10));
//    CATransform3DMakeTranslation(<#CGFloat tx#>, <#CGFloat ty#>, <#CGFloat tz#>)
//    CATransform3D moveTransform2 = CATransform3DTranslate(transform, 0, 10, 0);

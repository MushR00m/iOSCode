...
- (void)dealloc
{
    ...
    [_QF_searchDisplayController release];
    _QF_searchDisplayController = nil;
...
- (void)viewDidLoad
{
    ...
    _QF_searchDisplayController = [[UISearchDisplayController alloc] initWithSearchBar:_searchBar contentsController:self];
    
    _QF_searchDisplayController.searchResultsDataSource = self;
    _QF_searchDisplayController.searchResultsDelegate = self;
    _QF_searchDisplayController.delegate = self;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (_tableView != tableView)
    {
        ...
        //把搜索结果的表视图隐藏起来
        [_QF_searchDisplayController setActive:NO animated:YES];

...
- (void)viewDidLoad
{
    ...
    _tabBarController.viewControllers = [NSArray arrayWithObjects:_view1Controller, _view2Controller, _view3Controller, _view4Controller, _view5Controller,_view6Controller, nil];

...
- (IBAction)downloadPhoto2:(id)sender
{
    ...
    [assetsLibrary assetForURL:imageURL resultBlock:^(ALAsset *asset) {
        ...
        self.imagView.image = [UIImage imageWithCGImage:[asset defaultRepresentation].fullResolutionImage scale:1 orientation:(UIImageOrientation)([asset defaultRepresentation].orientation)] ;
